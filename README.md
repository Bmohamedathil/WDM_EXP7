...
### Output:
![image](https://github.com/user-attachments/assets/ed985396-e7e3-48f5-8c64-6c3bb01d09b7)

### Result:

The HITS algorithm was successfully implemented in Python.
Authority and Hub scores for each node were calculated and visualized using a bar chart.
